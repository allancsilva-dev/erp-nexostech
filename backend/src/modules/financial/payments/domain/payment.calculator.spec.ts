...
describe('PaymentCalculator', () => {
  it('returns PAID when decimal installments fully settle the entry (1000/3)', () => {
    ...
    const status = calculator.determineStatus('1000.00', [
      '333.33',
      '333.33',
      '333.34',
    ]);
  ...
  it('returns PARTIAL when rounding leaves a positive balance', () => {
    ...
    const remaining = calculator.calculateRemainingBalance('10.00', [
      '3.33',
      '3.33',
      '3.33',
    ]);
    const status = calculator.determineStatus('10.00', [
      '3.33',
      '3.33',
      '3.33',
    ]);
