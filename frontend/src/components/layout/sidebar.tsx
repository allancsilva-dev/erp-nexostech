...
export function Sidebar({ isVisible }: { isVisible: boolean }) {
  ...
  return (
    <aside
      className={cn(
          'hidden shrink-0 border-r-0 transition-[width,padding,background-color] duration-300 lg:flex lg:flex-col h-screen overflow-hidden bg-[hsl(var(--sidebar-bg))]',
    ...
    >
      ...
      <nav className="scrollbar-thin flex-1 overflow-y-auto pr-0" aria-label="Navegação do ERP">
       ...
       <div className="mt-auto border-t pt-3 bg-[hsl(var(--sidebar-bg))]" style={{ borderColor: 'hsl(0 0% 100% / 0.15)' }}>
