...
const normalItem = `${baseItem} text-[hsl(var(--sidebar-text-muted))] hover:translate-x-0.5 hover:bg-[hsl(var(--background)/0.88)] hover:text-[hsl(var(--sidebar-text))]`;
...
export function Sidebar({ isVisible }: { isVisible: boolean }) {
  ...
  return (
    ...
    >
        <button
          type="button"
          className="group/sidebar-brand mb-3 inline-flex items-center gap-2 overflow-hidden rounded-xl px-2 py-2 text-left transition-colors duration-300 hover:bg-[hsl(var(--background)/0.88)]"
